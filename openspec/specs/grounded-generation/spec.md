...
rather than treating them as user-submitted material. Prevents the model from attributing
retrieved scripture to the person asking (observed leak: "the scriptures *you have
presented*…").
